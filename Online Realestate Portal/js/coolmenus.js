...
*/
oCMenu.makeMenu('top','','<b>&nbsp;Home</b>','home.php', 'Frame3')

oCMenu.makeMenu('top0','','<b>Plots</b>','','')
oCMenu.makeMenu('sub00','top0','&nbsp;New Plot&nbsp;','AddPlot.php','Frame3')
oCMenu.makeMenu('sub01','top0','&nbsp;View','viewPlot.php','Frame3')
oCMenu.makeMenu('sub02','top0','&nbsp;Edit','editPlot.php','Frame3')
oCMenu.makeMenu('top1','','<b>Appartments</b>','','')
oCMenu.makeMenu('sub10','top1','&nbsp;New Appartment&nbsp;','addAppartment.php','Frame3')
oCMenu.makeMenu('sub11','top1','&nbsp;View','ViewAppartments.php','Frame3')
oCMenu.makeMenu('top2','','<b>&nbsp;Sales&nbsp;</b>','','')
oCMenu.makeMenu('sub20','top2','&nbsp;Sales&nbsp;>','')
oCMenu.makeMenu('sub200','sub20','&nbsp;New Entry','salesEntry.php','Frame3')
oCMenu.makeMenu('sub201','sub20','&nbsp;Alter Details','alterSalesEntry.php','Frame3')
oCMenu.makeMenu('sub202','sub20','&nbsp;Veiw Details','viewSaleEntries.php','Frame3')
oCMenu.makeMenu('sub21','top2','&nbsp;Payments&nbsp;>','')
oCMenu.makeMenu('sub210','sub21','&nbsp;Make Payment','MadePayment.php','Frame3')
oCMenu.makeMenu('sub211','sub21','&nbsp;View Payments','viewPayment.php','Frame3')
oCMenu.makeMenu('sub22','top2','&nbsp;Reports&nbsp;>','','')
oCMenu.makeMenu('sub220','sub22','&nbsp;Sundry Debitors','sunDebitors.php','Frame3')
oCMenu.makeMenu('sub221','sub22','&nbsp;Sundry Creditors','sundryCreditors.php','Frame3')
oCMenu.makeMenu('top3','','<b>&nbsp;Employees&nbsp;</b>','','')
oCMenu.makeMenu('sub30','top3','&nbsp;Add Employee&nbsp;','addEmployee2.php','Frame3')
oCMenu.makeMenu('sub31','top3','&nbsp;View Employees','consolidatedSort.php','Frame3')
oCMenu.makeMenu('top4','','&nbsp;Reports&nbsp;','')
oCMenu.makeMenu('sub40','top4','&nbsp;Sold Plots','soldPlot.php','Frame3')
oCMenu.makeMenu('sub41','top4','&nbsp;Reserved Plots','reservedPlot.php','Frame3')
oCMenu.makeMenu('sub42','top4','&nbsp;Vacant Plots','vacantPlot.php','Frame3')

oCMenu.makeMenu('top5','','<b>&nbsp;About</b>','about.php','')//,0,0,"","",'red','silver')
oCMenu.makeMenu('top6','','<b>&nbsp;Logout</b>','logout.php','_top')//,0,0,"","",'red','silver')
